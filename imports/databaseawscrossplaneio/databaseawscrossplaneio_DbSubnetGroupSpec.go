...
type DbSubnetGroupSpec struct {
	...
	DeletionPolicy DbSubnetGroupSpecDeletionPolicy `field:"optional" json:"deletionPolicy" yaml:"deletionPolicy"`
	// DBSubnetGroupParameters define the desired state of an AWS VPC Database Subnet Group.
	ForProvider *DbSubnetGroupSpecForProvider `field:"optional" json:"forProvider" yaml:"forProvider"`
	// ProviderConfigReference specifies how the provider that will be used to create, observe, update, and delete this managed resource should be configured.
	ProviderConfigRef *DbSubnetGroupSpecProviderConfigRef `field:"optional" json:"providerConfigRef" yaml:"providerConfigRef"`
	...
	ProviderRef *DbSubnetGroupSpecProviderRef `field:"optional" json:"providerRef" yaml:"providerRef"`
	...
	PublishConnectionDetailsTo *DbSubnetGroupSpecPublishConnectionDetailsTo `field:"optional" json:"publishConnectionDetailsTo" yaml:"publishConnectionDetailsTo"`
	...
	WriteConnectionSecretToRef *DbSubnetGroupSpecWriteConnectionSecretToRef `field:"optional" json:"writeConnectionSecretToRef" yaml:"writeConnectionSecretToRef"`
}
