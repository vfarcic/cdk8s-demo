...
func (j *jsiiProxy_SecurityGroup) ApiGroup() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiGroup",
...
func (j *jsiiProxy_SecurityGroup) ApiVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiVersion",
...
func (j *jsiiProxy_SecurityGroup) Chart() cdk8s.Chart {
...
func (j *jsiiProxy_SecurityGroup) Kind() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kind",
...
func (j *jsiiProxy_SecurityGroup) Metadata() cdk8s.ApiObjectMetadataDefinition {
...
func SecurityGroup_Manifest(props *SecurityGroupProps) interface{} {
	_init_.Initialize()

	if err := validateSecurityGroup_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func SecurityGroup_Of(c constructs.IConstruct) cdk8s.ApiObject {
	_init_.Initialize()

	if err := validateSecurityGroup_OfParameters(c); err != nil {
		panic(err)
	}
...
func SecurityGroup_GVK() *cdk8s.GroupVersionKind {
	_init_.Initialize()
...
func (s *jsiiProxy_SecurityGroup) AddDependency(dependencies ...constructs.IConstruct) {
	args := []interface{}{}
...
func (s *jsiiProxy_SecurityGroup) AddJsonPatch(ops ...cdk8s.JsonPatch) {
	args := []interface{}{}
	for _, a := range ops {
		args = append(args, a)
	}
...
func (s *jsiiProxy_SecurityGroup) ToJson() interface{} {
	var returns interface{}
