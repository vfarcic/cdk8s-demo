...
func (j *jsiiProxy_Vpc) ApiGroup() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiGroup",
...
func (j *jsiiProxy_Vpc) ApiVersion() *string {
	var returns *string
	_jsii_.Get(
		j,
		"apiVersion",
...
func (j *jsiiProxy_Vpc) Chart() cdk8s.Chart {
...
func (j *jsiiProxy_Vpc) Kind() *string {
	var returns *string
	_jsii_.Get(
		j,
		"kind",
...
func (j *jsiiProxy_Vpc) Metadata() cdk8s.ApiObjectMetadataDefinition {
...
func Vpc_Manifest(props *VpcProps) interface{} {
	_init_.Initialize()

	if err := validateVpc_ManifestParameters(props); err != nil {
		panic(err)
	}
...
func Vpc_Of(c constructs.IConstruct) cdk8s.ApiObject {
	_init_.Initialize()

	if err := validateVpc_OfParameters(c); err != nil {
		panic(err)
	}
...
func Vpc_GVK() *cdk8s.GroupVersionKind {
	_init_.Initialize()
...
func (v *jsiiProxy_Vpc) AddDependency(dependencies ...constructs.IConstruct) {
	args := []interface{}{}
...
func (v *jsiiProxy_Vpc) AddJsonPatch(ops ...cdk8s.JsonPatch) {
	args := []interface{}{}
	for _, a := range ops {
		args = append(args, a)
	}
...
func (v *jsiiProxy_Vpc) ToJson() interface{} {
	var returns interface{}
