...
type SecurityGroupSpecForProviderIngress struct {
	...
	// The IPv4 ranges.
	IpRanges *[]*SecurityGroupSpecForProviderIngressIpRanges `field:"optional" json:"ipRanges" yaml:"ipRanges"`
	// The IPv6 ranges.
	//
	// [VPC only].
	Ipv6Ranges *[]*SecurityGroupSpecForProviderIngressIpv6Ranges `field:"optional" json:"ipv6Ranges" yaml:"ipv6Ranges"`
	...
	// [VPC only].
	PrefixListIds *[]*SecurityGroupSpecForProviderIngressPrefixListIds `field:"optional" json:"prefixListIds" yaml:"prefixListIds"`
	...
	UserIdGroupPairs *[]*SecurityGroupSpecForProviderIngressUserIdGroupPairs `field:"optional" json:"userIdGroupPairs" yaml:"userIdGroupPairs"`
}
