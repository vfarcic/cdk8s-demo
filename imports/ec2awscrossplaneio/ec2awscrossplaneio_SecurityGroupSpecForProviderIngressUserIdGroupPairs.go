...
type SecurityGroupSpecForProviderIngressUserIdGroupPairs struct {
	...
	GroupIdRef *SecurityGroupSpecForProviderIngressUserIdGroupPairsGroupIdRef `field:"optional" json:"groupIdRef" yaml:"groupIdRef"`
	// GroupIDSelector selects reference to a security group to retrieve its GroupID.
	GroupIdSelector *SecurityGroupSpecForProviderIngressUserIdGroupPairsGroupIdSelector `field:"optional" json:"groupIdSelector" yaml:"groupIdSelector"`
	...
	VpcIdRef *SecurityGroupSpecForProviderIngressUserIdGroupPairsVpcIdRef `field:"optional" json:"vpcIdRef" yaml:"vpcIdRef"`
	// VPCIDSelector selects reference to a VPC to retrieve its vpcId.
	VpcIdSelector *SecurityGroupSpecForProviderIngressUserIdGroupPairsVpcIdSelector `field:"optional" json:"vpcIdSelector" yaml:"vpcIdSelector"`
